...
def do_math_operation_with_numbers(value1, value2, op_type, is_advanced):
    """do_math_operation_with_numbers function.

Args: value1, value2, op_type, is_advanced."""
    if op_type == 'add':
        if is_advanced == True:
...
class UserManager:
    ...
    def process_usr_lst_data_complex(self, lst_of_usr_dicts, include_admins, filter_by_age, min_age_thresh):
        """process_usr_lst_data_complex function.

Args: self, lst_of_usr_dicts, include_admins, filter_by_age, min_age_thresh."""
...
def main():
    ...
    a2 = do_math_operation_with_numbers(10, 5, 'add', False)
    print('res 1:', a1)
    print('res 2:', a2)
    manager = UserManager()
